...
namespace BehaviourTreeLogic
{
    ...
    {
        private BehaviourTreeEditorUtility.ScriptTemplate scriptTemplate;
        ...
        public void CreateScript(BehaviourTreeEditorUtility.ScriptTemplate scriptTemplate, NodeView source, bool isSourceParent,
            Vector2 position)
        {
        ...
        private void OnConfirm()
        {
            ...
            if (AssetDatabase.IsValidFolder(newNodePath))
            {
                ...
                var scriptPath = System.IO.Path.Combine(parentPath.ToString(), destinationPath);
